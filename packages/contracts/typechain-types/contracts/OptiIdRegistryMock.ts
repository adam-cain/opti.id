...
export interface OptiIdRegistryMockInterface extends utils.Interface {
  functions: {
    ...
    "testRegisterDomain(string,address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testRegisterDomain",
...
export interface OptiIdRegistryMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OptiIdRegistryMockInterface;
