...
# 3D Superchain Coin Animation

This project includes a 3D rotating coin animation that cycles through different superchain logos.

## Coin Animation Setup

The coin animation is built with Three.js and React Three Fiber. It displays a 3D golden coin that rotates and changes its logo with each full rotation.

### How to Add Your Own Logo Images

Replace the placeholder image files in the `public/images/` directory:

- `public/images/base.png` - Base logo
- `public/images/optimism.png` - Optimism logo
- `public/images/degen.png` - Degen logo
- `public/images/unichain.png` - Unichain logo
...
If image loading fails, the component will display a placeholder with the chain name.

### How to Customize

You can customize the coin animation by editing the `src/components/CoinAnimation.tsx` file:

- Change the coin color (currently gold)
- Adjust rotation speed
- Add more logos to the rotation
- Modify coin dimensions or thickness
